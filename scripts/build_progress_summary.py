...
OFFBOARD_STEPS_RHOAI = [
    ...
    ("remove_krd",             "Remove from Konflux release data (PDS)", "mr_url"),
    ("remove_krd_rpa",         "Remove from ReleasePlanAdmission",      "mr_url"),
...
_OFFBOARD_DEPENDENCY: dict[str, str] = {
    ...
    "remove_okc":      "remove_krd + remove_krd_rpa (when remove_pull_pipelines also done)",
    "remove_pull_pipelines": "remove_krd + remove_krd_rpa (when remove_okc also done)",
}
